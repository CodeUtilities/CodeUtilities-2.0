...
import io.github.codeutilities.sys.util.color.ColorUtil;
import io.github.codeutilities.sys.util.color.HSBColor;
import io.github.codeutilities.sys.util.gui.IMenu;
import io.github.codeutilities.sys.util.gui.widgets.*;
...
public class ColorsGui extends LightweightGuiDescription implements IMenu {
    ...
    public void open(String... args) {
        try{
            ...
            hexInput = new WTextField(new LiteralText("HEX")).setMaxLength(7);
            ...
            rInput = new WTextField(new LiteralText("Red")).setMaxLength(3);
            gInput = new WTextField(new LiteralText("Green")).setMaxLength(3);
            bInput = new WTextField(new LiteralText("Blue")).setMaxLength(3);
            rInput.setText("255");
            gInput.setText("0");
            bInput.setText("0");
    ...
    public static ColorsGui getGUI(){
        return (ColorsGui) ((CottonClientScreen) MinecraftClient.getInstance().currentScreen).getDescription();
    }
